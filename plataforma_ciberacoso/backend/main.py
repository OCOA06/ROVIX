...
def query_llm(messages: list, json_mode: bool = False) -> str:
    ...
    try:
        ...
        print(f"Error calling Pollinations AI directly: {e}")
    return None
...
async def chat_api(req: ChatRequest):
    ...
    # 1. Intento primario: Pollinations AI directo
...
async def analyze_message(req: AnalyzeRequest):
    ...
    # 1. Intento primario: Pollinations AI directo (con JSON mode)
    ...
    # Categoría 2: Grooming / Acoso de Menores
    groom_words = [
    ...
    # Categoría 3: Chantaje / Sextorsión / Manipulación
    manip_words = [
    ...
    # Categoría 4: Insultos / Acoso Verbal
    harass_words = [
    ...
    # Categoría 5: Acoso Persistente / Intrusión
    stalk_words = [
